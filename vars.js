export const llmDistilleryVars = {
    ...
    LLM_SYSTEM_PROMPT: `Please summarize the text snippet below. Ensure that all critical information and key facts are included in the summary. Your response should strictly follow this JSON format: {"summary": "your_summary_here"}. Do not include any additional text or explanation in your response. Here is an example for clarity:
